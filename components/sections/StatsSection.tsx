...
export default function StatsSection({ config }: { config?: HomepageConfig }) {
  ...
  const label = config?.statsLabel || HOMEPAGE_DEFAULTS.statsLabel;

  return (
    <section className="relative py-20 lg:py-28 bg-slate-50 border-y border-slate-100 overflow-hidden" ref={ref}>
      {/* Background glow */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[600px] h-[400px] bg-nova-red/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[400px] bg-orange-100/30 rounded-full blur-[100px]" />
        {/* Grid lines */}
        <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <motion.div
             ...
             className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 border border-orange-200 text-nova-orange text-xs font-bold uppercase tracking-widest mb-6 shadow-sm"
          >
          ...
          <motion.h2
            ...
            className="text-3xl md:text-5xl font-black text-slate-900 mb-4 leading-tight"
          >
          ...
          {statsList.map((s, i) => {
            return (
              <motion.div
                ...
                className="group relative bg-white border border-slate-100 rounded-2xl p-6 text-center hover:shadow-xl hover:border-orange-200 transition-all duration-300 cursor-default overflow-hidden"
              >
                ...
                <div className={`text-3xl lg:text-4xl font-black mb-1 bg-gradient-to-r ${s.accent} bg-clip-text text-transparent`}>
                 ...
                 <p className="text-slate-800 font-semibold text-sm mb-1">{s.label}</p>
        ...
        >
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 bg-gray-50 shadow-sm">
            <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-gray-500 text-xs font-medium">Données mises à jour en temps réel</span>
          </div>
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
        </motion.div>
      </div>
