...
const PAGE_CONTENT_FIELDS: Record<string, ContentField[]> = {
  ...
  "services/location-voiture": [
    { group: "Textes", key: "hero.title",    label: "Titre du service",           hint: "Ex : Location de Voiture", type: "text" },
    { group: "Textes", key: "hero.subtitle", label: "Sous-titre",                  hint: "Ex : Courte & longue durée", type: "textarea" },
    { group: "Textes", key: "description",   label: "Description complète",        hint: "Texte de présentation",    type: "textarea" },
    { group: "Textes", key: "cta.btn",       label: "Texte du bouton de contact",  hint: "Ex : Réserver maintenant", type: "text" },
  ],
  "services/location-immo": [
    { group: "Textes", key: "hero.title",    label: "Titre du service",  type: "text" },
    { group: "Textes", key: "hero.subtitle", label: "Sous-titre",        type: "textarea" },
    { group: "Textes", key: "description",   label: "Description complète", type: "textarea" },
    { group: "Textes", key: "cta.btn",       label: "Texte du bouton",   type: "text" },
  ],
