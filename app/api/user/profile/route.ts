...
export async function GET() {
  ...
  const user = await prisma.user.findUnique({
    ...
    select: { id: true, name: true, email: true, phone: true, userType: true, role: true, avatar: true, bio: true, company: true, city: true, website: true, facebook: true, instagram: true, twitter: true, linkedin: true, whatsapp: true, subscriptionPlan: true, subscriptionExpiresAt: true, createdAt: true },
  });
